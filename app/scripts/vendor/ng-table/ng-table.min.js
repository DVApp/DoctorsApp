! function(e, t) {
    ...
    t.factory("ngTableParams", ["$q", "$log", function(t, a) {
        var n = function(e) {
            ...
            r = function(r, i) {
                ...
                this.data = [], this.parameters = function(t, a) {
                    if (a = a || !1, e.isDefined(t)) {
                        for (var r in t) {
                            var i = t[r];
                            if (a && r.indexOf("[") >= 0) {
                                for (var s = r.split(/\[(.*)\]/).reverse(), c = "", p = 0, u = s.length; u > p; p++) {
                                    var g = s[p];
                                    if ("" !== g) {
                                        var m = i;
                                        i = {}, i[c = g] = n(m) ? parseFloat(m) : m
                                    }
                                }
                                "sorting" === c && (o[c] = {}), o[c] = e.extend(o[c] || {}, i[c])
                            } else o[r] = n(t[r]) ? parseFloat(t[r]) : t[r]
                        }
                        return l("ngTable: set parameters", o), this
                    }
                    return o
                }, this.settings = function(t) {
                    return e.isDefined(t) ? (e.isArray(t.data) && (t.total = t.data.length), c = e.extend(c, t), l("ngTable: set settings", c), this) : c
                    ...
                    return e.isDefined(o.sorting[t]) && o.sorting[t] == a
                }, this.orderBy = function() {
                    var e = [];
                    for (var t in o.sorting) e.push(("asc" === o.sorting[t] ? "+" : "-") + t);
                    return e
                }, this.getData = function(t, a) {
                    t.resolve(e.isArray(this.data) && e.isObject(a) ? this.data.slice((a.page() - 1) * a.count(), a.page() * a.count()) : [])
                    ...
                    r.promise.then(function(t) {
                        ...
                        l("ngTable: refresh groups", i), a.resolve(i)
                    }), this.getData(r, s)
                    ...
                    if (n = 11, o = [], l = Math.ceil(t / a), l > 1) {
                        ...
                        for (var c = s; r >= c;) o.push(c === s && 2 !== c || c === r && c !== l - 1 ? {
                            type: "more",
                            active: !1
                        } : {
                            type: "page",
                    ...
                    var e = t.defer(),
                        a = this;
                    c.$loading = !0, c.groupBy ? c.getGroups(e, c.groupBy, this) : c.getData(e, this), l("ngTable: reload data"), e.promise.then(function(e) {
                        c.$loading = !1, l("ngTable: current scope", c.$scope), a.data = c.groupBy ? c.$scope.$groups = e : c.$scope.$data = e, c.$scope.pages = a.generatePagesArray(a.page(), a.total(), a.count()), c.$scope.$emit("ngTableAfterReloadData")
                    })
                }, this.reloadPages = function() {
                    var e = this;
                    c.$scope.pages = e.generatePagesArray(e.page(), e.total(), e.count())
                };
                var o = this.$params = {
                        page: 1,
                        count: 1,
                ...
                return this.settings(i), this.parameters(r, !0), this
            };
        return r
    }]);
    var a = ["$scope", "ngTableParams", "$timeout", function(t, a, n) {
        t.$loading = !1, t.params || (t.params = new a), t.params.settings().$scope = t;
        var r = function() {
            var e = 0;
            return function(t, a) {
                n.cancel(e), e = n(t, a)
        ...
        t.$watch("params.$params", function(a, n) {
            t.params.settings().$scope = t, e.equals(a.filter, n.filter) ? t.params.reload() : r(function() {
                t.params.$params.page = 1, t.params.reload()
            }, t.params.settings().filterDelay)
        }, !0), t.sortBy = function(e, a) {
            var n = t.parse(e.sortable);
            if (n) {
                var r = t.params.settings().defaultSort,
                    i = "asc" === r ? "desc" : "asc",
                    s = t.params.sorting() && t.params.sorting()[n] && t.params.sorting()[n] === r,
                    l = a.ctrlKey || a.metaKey ? t.params.sorting() : {};
                l[n] = s ? i : r, t.params.parameters({
                    sorting: l
                })
            }
        }
                ...
                return e.forEach(e.element(a.find("tr")), function(t) {
                    ...
                    if (!a.attr("ignore-cell") || "true" !== a.attr("ignore-cell")) {
                        var s = function(e, t) {
                            ...
                            p = !1,
                            u = !1;
                        c && c.$$name && (u = c.$$name, delete c.$$name), c && c.templateURL && (p = c.templateURL, delete c.templateURL), a.attr("data-title-text", l()), n.push({
                            id: i++,
                            title: l,
                    ...
                    if (a.$loading = !1, a.$columns = n, a.$watch(s.ngTable, function(t) {
                            ...
                            var n;
                            if (t.filterData) {
                                if (n = r(t.filterData)(a, {
                                        $column: t
                                    }), !e.isObject(n) || !e.isObject(n.promise)) throw new Error("Function " + t.filterData + " must be instance of $q.defer()");
                                return delete t.filterData, n.promise.then(function(a) {
                                    e.isArray(a) || (a = []), a.unshift({
                                        title: "-",
                                        id: ""
                                    }), t.data = a
                                })
