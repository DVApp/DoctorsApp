            ...
            compile: function (element) {
                ...
                return function (scope, element, attrs) {
                    ...
                    if (!element.hasClass('ng-table')) {
                        ...
                        if ("paginationBottom" in attrs || !("paginationTop" in attrs)) {
                        	
                            var paginationTemplate = angular.element(document.createElement('div')).attr('ng-include', 'templates.pagination');                                   $compile(paginationTemplate)(scope);
                            element.after(paginationTemplate);
                        // } /* Commented based on bottom and top show the paging, uncomment it's working paggination show on bottom*/
                        // if ("paginationTop" in attrs) { /* Commented based on bottom and top show the paging, uncomment it's working paggination show on bottom */
                            var paginationTemplate = angular.element(document.createElement('div')).attr('ng-include', 'templates.pagination').css('paddingTop', '1px');
